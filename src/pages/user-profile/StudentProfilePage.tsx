...
export default function StudentProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F6F6F8]">
            ...
            <div className="bg-gradient-to-r from-[#3758FB] to-[#9221FB] text-white">
                <div className="container mx-auto px-4 py-8">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        <Avatar className="h-24 w-24 border-4 border-white/20">
                            <AvatarImage src={studentData.avatar || "/placeholder.svg"} alt={`${studentData.firstName} ${studentData.lastName}`} />
                        ...
                        <div className="text-center md:text-left">
                            <h1 className="text-3xl font-bold mb-2">{`${studentData.firstName} ${studentData.lastName}`}</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <Tabs defaultValue="personal" className="space-y-6">
                        <TabsList className="grid w-full grid-cols-2 bg-white shadow-sm">
                            <TabsTrigger
                                value="personal"
                                className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#3758FB] data-[state=active]:to-[#9221FB] data-[state=active]:text-white"
                            >
                        ...
                        <TabsContent value="personal" className="space-y-6">
                            <Card className="shadow-sm border-0">
                                <CardHeader className="bg-gradient-to-r from-[#3758FB]/5 to-[#9221FB]/5">
